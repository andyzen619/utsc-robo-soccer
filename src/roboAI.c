 ...
 **************************************************************************/
  ...
  *****************************************************************************/
  ...
  if(ai->st.state >= 101 && ai->st.state < 200){
    ...
    switch(ai->st.state) {
      case 101  : // turning to face the ball
        ...
        //theta = angleOfTwo(ai->st.ball->cx, ai->st.ball->cy, ai->st.self->cx, ai->st.self->cy);
        //fprintf(stderr, "%f\n", theta);
        fprintf(stderr, "x:%f, y:%f", x_distance, y_distance);
      	//fprintf(stderr, "distance is %f\n",distance);
        //fprintf(stderr, "angle is %f\n", theta);
        //fprintf(stderr, "heading of bot is %f\n",ai->st.self.smx);
      ...
      case 102  : //moving towards ball
        fprintf(stderr, "state102\n");
        ai->st.state +=1;
        break;
      case 103  : //
        fprintf(stderr, "state103\n");
        ai->st.state +=1;
        break;
      case 104  :
        fprintf(stderr, "state104\n");
        ai->st.state +=1;
        break;
      case 105  :
        fprintf(stderr, "state105\n");
        ai->st.state +=1;
        break;
      case 106  :
        fprintf(stderr, "end!!!!!!!!!!!!!!!!\n");
